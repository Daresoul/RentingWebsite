...
import com.renting.rentingwebsite.UTILS;
...
public class StripeController {
    ...
    @Autowired
    public StripeController(WebhookService webhookService, StripeService paymentService, RentableItemRepository rentableItemRepository, PaymentIntentLogRepository paymentIntentLogRepository) {
    ...
    public StripeIntentDTO createPaymentIntent(@RequestBody StripePaymentInfoRequestDTO paymentInfoRequest, @CurrentUser User user) throws StripeException, BadRequestException {
        ...
        logger.warn("start date is {}", startDate);
        logger.warn("end date is {}", endDate);
